 ...
 *
 * 3. Accessing the account setting page should be blank by default with a message
 *    informing the user that the account setting will be used for the default
 *    project number.
 *
  ...
  public static function getInfo() {
    ...
    return array(
      ...
      'description' => 'Test the existence of a disabled default project.' . 
        ...
        ' the default snippet is added to the front page' . 
        ' (default) of the site.',
      'group' => 'Optimizely',
);
